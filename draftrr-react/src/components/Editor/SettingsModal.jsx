...
export const SettingsModal = ({ showModal, setShowModal, handleCloseModal, handleUpdate, saveSettings }) => {
    ...
    const submittedState = currentProject.Submitted
    ...
    return (
        <Modal show={showModal} onHide={handleCloseModal}>
            ...
            <Modal.Body className="d-flex flex-column">
                ...
                <input value={currentProject.Title} onChange={handleUpdate} type="text" name="Title" autoFocus disabled={submittedState} required/>
                
                <label htmlFor="timeFrame">Seconds Editable: <span className="font-weight-normal">{currentProject.ProjectTimeframe}</span></label>
                <input type="range" id="timeFrame" name="ProjectTimeframe" min="1" max="60" disabled={submittedState} value={currentProject.ProjectTimeframe} onChange={handleUpdate}  />
                ...
                <input type="range" id="maxCharacters" name="ProjectMaxCharacters" min="100" max="1000" disabled={submittedState} value={currentProject.ProjectMaxCharacters} onChange={handleUpdate} />
